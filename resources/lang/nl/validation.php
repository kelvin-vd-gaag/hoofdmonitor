...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Hier kun je aangepaste validatieberichten definiëren voor je eigen regels.
    |
    */
    'regex' => 'Het :attribute moet een geldig @tcrmbo.nl of @zadkine.nl e-mailadres zijn.',

    /*
    |--------------------------------------------------------------------------
    | Standaard validatieberichten in het Nederlands
    |--------------------------------------------------------------------------
    |
    | De volgende regels bevatten de standaard foutmeldingen van Laravel die
    ...
    */
    ...
    'alpha_dash' => 'Het :attribute mag alleen letters, nummers, underscores en streepjes bevatten.',
    ...
    'lte' => [
        ...
        'string' => 'Het :attribute moet kleiner of gelijk zijn aan :value tekens.',
    ...
    |--------------------------------------------------------------------------
    |
    | Hier kun je de veldnamen aanpassen naar meer menselijke namen.
    |
    */
    'attributes' => [
        'email' => 'e-mailadres',
